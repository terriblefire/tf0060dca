...
# NOTE: all embedded footprints are drawn with their zero orientation
# matching JLCPCB's component library convention (horizontal, pin 1 /
# anode bottom-left or left), so the EAGLE rotation exports to the CPL
# as-is. If a new footprint is imported whose R0 differs (checked
# against JLC's 2D assembly render), re-zero the package geometry and
# compensate the element rotations rather than special-casing here.
